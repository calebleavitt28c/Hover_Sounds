...
class ArtistHome extends React.Component {
  ...
  playClick = () => {
    ...
    if (Cookies.get('spotifyAuthToken') !== undefined) {
      ...
      window.alert('Not logged into Spotify')
    }
  }
