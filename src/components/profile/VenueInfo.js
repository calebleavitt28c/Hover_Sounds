...
const VenueInfo = (props) => {
    ...
    console.log(venueAttributes.profilePic)
    return (
        <div className="grid grid-cols-4 gap-2">
            ...
            <p className="appearance-none block w-full col-span-3 bg-white text-gray border border-gray rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">{venueAttributes.bio}</p>
