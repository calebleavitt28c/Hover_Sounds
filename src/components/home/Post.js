  ...
  render() {
    return(
      <li className='mb-2 px-2'>
          <div className='px-5 py-4 bg-lightgray dark:bg-darkgray shadow-md hover:shadow-lg dark:shadow-gray dark:shadow-sm rounded-lg transition ease-in duration-100'>
