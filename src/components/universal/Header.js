      ...
      <nav className="flex items-center justify-between flex-wrap bg-primary dark:bg-darkgray border-b-2 border-secondary dark:border-primary p-4 ease-in duration-300">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          ...
          <div className="grid grid-cols-2">
            ...
            ) : <Link to="/auth" className="inline-block text-sm ml-2 leading-none text-white  dark:text-lightgray border-transparent hover:text-secondary dark:hover:text-primary ease-in duration-300">Login</Link>}
